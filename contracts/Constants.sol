...
library MainnetConstants {
    ...
    /// @dev Rage quit assistant deployer mainnet
    address constant RageQuitAssistantDeployer = 0xba459271cb1d821F8505ABe809c20A4c2BbA44b8;

    /// @dev Full withdrawals adaptor (unstaking ETH) mainnet
    address constant FullWithdrawals = 0x8F6839b0AcD8d7c7d2f01C1C7ECCa982Ca354333;

    /// @dev Shanghai partial withdrawals reporting adaptor (mainnet)
    address constant ShanghaiSweepReporter = 0x64f4fCFb8377DEaABF334eD42aC113E6813a55d0;
}
...
library GoerliConstants {
    ...
    /// @dev Rage quit assistant deployer goerli
    address constant RageQuitAssistantDeployer = 0x1B3EBfE294c98801e266fE7C9df92DD3e9A27396;

    /// @dev Full withdrawals adaptor (unstaking ETH) goerli
    address constant FullWithdrawals = 0x4aCB708eb8Def5D66Ff8Da7EE4796C4B3EDb44A4;

    /// @dev Shanghai partial withdrawals reporting adaptor (goerli)
    address constant ShanghaiSweepReporter = 0xF0be479a19a5553fC736E7208879b9019B07DE85;
}
